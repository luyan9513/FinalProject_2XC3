    ...
    while not Q.is_empty():
        ...
        for neighbour in G.adj[current_node]:
            if dist[current_node] + G.w(current_node, neighbour) < dist[neighbour]:
                line = connections[(current_node, neighbour)]  # Get the line used for this connection
...
for node in london_subway_graph.adj.keys():
    if london_subway_graph.adj[node]:
        h[node] = min(london_subway_graph.w(node, neighbor) for neighbor in london_subway_graph.adj[node])
    else:
        h[node] = 0
    ...
    for s in range(1,303):
        ...
        for d in range(s+1,303):
            ...
            for _ in range(t):
                ...
                pred, line, dist_d = a_star_for_part3(london_subway_graph, s, d, h)
...
def experiment2(t):
    ...
    for _ in range(t):
        ...
        ppred, ddist,lines_used = dijkstra_for_part3(london_subway_graph, s,connections)
...
def experiment3():
    dist, pred, lines_used = dijkstra_for_part3(london_subway_graph, s, connections)
    distance_by_line = total_distance_by_line(lines_used, london_subway_graph, pred)
